...
public class GetArticles extends SampleResponse {

  private static final String METHOD = "GET";
  private static final String REQUEST_URL =
      "http://support.kayako.com//api/v1/articles.json?_case=camel&include=localeField,category,section,userMinimal&limit=10&section_id=243&offset=0";
  private static final int STATUS_CODE = 200;

  private static final String MESSAGE_FILE = "articles";
