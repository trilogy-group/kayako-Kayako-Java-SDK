   ...
   */
    ...
    public void getErrors() throws Throwable {
        List<Error> retval;
        {
            ...
            Reflector.setField(param0, "errors", null);
            Reflector.setField(param0, "logs", null);
            Reflector.setField(param0, "notifications", null);
   ...
   */
    ...
    public void getErrors1() throws Throwable {
        List<Error> retval;
        {
            ...
            Reflector.setField(param3, "errors", param2);
            Reflector.setField(param3, "logs", null);
            Reflector.setField(param3, "notifications", null);
   ...
   */
    ...
    public void getLogs() throws Throwable {
        List<Log> retval;
        {
            ...
            ArrayList param2 = new ArrayList();
            ResponseMessages param3 = (ResponseMessages) Reflector.getInstance("com.kayako.sdk.error.ResponseMessages");
            Reflector.setField(param3, "errors", null);
            Reflector.setField(param3, "logs", param2);
            Reflector.setField(param3, "notifications", null);
            Reflector.setField(param3, "statusCode", 0);
            /* Act */
   ...
   */
    ...
    public void getNotifications() throws Throwable {
        List<Notification> retval;
        {
            ...
            Reflector.setField(param3, "errors", null);
            Reflector.setField(param3, "logs", null);
            Reflector.setField(param3, "notifications", param2);
            Reflector.setField(param3, "statusCode", 0);
            /* Act */
