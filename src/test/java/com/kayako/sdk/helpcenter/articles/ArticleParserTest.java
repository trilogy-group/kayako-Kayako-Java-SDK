...
public class ArticleParserTest {
    ...
    public void parse() throws Exception {
        ...
        String jsonSample = "{\n" +
                ...
                "                    \"created_at\": \"2016-06-23T14:14:35+00:00\",\n" +
                "                    \"updated_at\": \"2016-06-23T14:14:35+00:00\",\n" +
                "                    \"resource_type\": \"locale_field\",\n" +
                "                    \"resource_url\": \"https://support.kayako.com/api/v1/locale/fields/1503\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"slugs\": [\n" +
                "                {\n" +
                ...
                "                    \"updated_at\": \"2016-06-23T14:14:35+00:00\",\n" +
                "                    \"resource_type\": \"locale_field\",\n" +
                "                    \"resource_url\": \"https://support.kayako.com/api/v1/locale/fields/1504\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"keywords\": null,\n" +
                "            \"section\": {\n" +
                ...
                "            \"total_comments\": 0,\n" +
                "            \"created_at\": \"2016-06-23T14:14:35+00:00\",\n" +
                "            \"published_at\": \"2016-06-23T14:14:35+00:00\",\n" +
                "            \"updated_at\": \"2016-07-03T00:00:48+00:00\",\n" +
                "            \"resource_type\": \"article\",\n" +
                "            \"resource_url\": \"https://support.kayako.com/api/v1/articles/1145\"\n" +
                "        },\n" +
                "        {\n" +
                "            \"id\": 1179,\n" +
                ...
                "                    \"created_at\": \"2016-06-30T16:13:55+00:00\",\n" +
                "                    \"updated_at\": \"2016-06-30T16:13:55+00:00\",\n" +
                "                    \"resource_type\": \"locale_field\",\n" +
                "                    \"resource_url\": \"https://support.kayako.com/api/v1/locale/fields/1589\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"slugs\": [\n" +
                "                {\n" +
                ...
                "                    \"updated_at\": \"2016-06-30T16:13:55+00:00\",\n" +
                "                    \"resource_type\": \"locale_field\",\n" +
                "                    \"resource_url\": \"https://support.kayako.com/api/v1/locale/fields/1590\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"keywords\": null,\n" +
                "            \"section\": {\n" +
                ...
                "            \"total_comments\": 0,\n" +
                "            \"created_at\": \"2016-06-30T16:13:55+00:00\",\n" +
                "            \"published_at\": \"2016-06-30T23:20:05+00:00\",\n" +
                "            \"updated_at\": \"2016-07-03T00:01:25+00:00\",\n" +
                "            \"resource_type\": \"article\",\n" +
                "            \"resource_url\": \"https://support.kayako.com/api/v1/articles/1179\"\n" +
                "        },\n" +
                "        {\n" +
                "            \"id\": 1178,\n" +
                "            \"uuid\": \"d319f8a0-9417-5ee2-b621-013e0994630f\",\n" +
                "            \"titles\": [\n" +
                "                {\n" +
                "                    \"id\": 1587,\n" +
                "                    \"locale\": \"en-us\",\n" +
                "                    \"translation\": \"Navigating the agent area\",\n" +
                "                    \"created_at\": \"2016-06-30T16:13:11+00:00\",\n" +
                "                    \"updated_at\": \"2016-06-30T16:13:11+00:00\",\n" +
                "                    \"resource_type\": \"locale_field\",\n" +
                "                    \"resource_url\": \"https://support.kayako.com/api/v1/locale/fields/1587\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"slugs\": [\n" +
                "                {\n" +
                "                    \"locale\": \"en-us\",\n" +
                "                    \"translation\": \"1178-navigating-the-agent-area\",\n" +
                "                    \"resource_type\": \"slug\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"contents\": [\n" +
                ...
                "                    \"id\": 1588,\n" +
                "                    \"locale\": \"en-us\",\n" +
                "                    \"translation\": \"<p>Your support team will be spending the majority of their time in Kayako's agent area. From here they can keep track of the support queue, reply to and resolve cases, and search through all of the user, organization, and case information that Kayako stores.</p><p>In this article, we'll introduce you to the agent area, and call out some of the features you'll be using most often. We'll include links to other articles that will go into each feature in more detail.</p><h2>Learning your way around the agent area</h2><p>You can sign in to the agent area by adding '/agent' to the end of your Help Center URL. Once you're in, you'll see the inbox for your support queue, as well as a search bar and some icons up on the toolbar.</p><p>Let's take a look at the main elements on the agent area interface:</p><ul><li><p><strong>Inbox and case views</strong> — The inbox is the default case view of your support queue, showing you all your teams' open cases. You can click on any case to open it for updates. You can also update multiple cases at once, by checking them and making your changes in the 'Update cases' panel that appears.<br><img class=\\\"fr-dib fr-draggable\\\" src=\\\"https://support.kayako.com/base/media/url/zH8eqpxitPG0qiYnZSpnrU3ngkjSTESB\\\" style=\\\"width: 588px; height: 285.927px;\\\" data-status=\\\"201\\\" data-data=\\\"[object Object]\\\" data-resource=\\\"media\\\" data-total_count=\\\"1\\\">In the sidebar, you'll see a list of case views, each of which will display a different filtered view of your cases. You can define as many views you as you like, to suit the needs of your team.</p><p>Learn more in <a href=\\\"https://support.kayako.com/article/1150-adding-and-editing-views\\\">our article creating custom case views of your support cases</a>.</p></li><li><p><strong>Search bar</strong> — At the top right, you'll see the agent search bar. From here, you can search... pretty much every corner of Kayako. The search bar will return results from cases, users, organizations, Help Center articles, you name it. You can refine your search using a number of search modifiers. For example, you can use 'in:cases' to limit your results to cases that match your criteria.<br><img class=\\\"fr-dib fr-draggable\\\" src=\\\"https://support.kayako.com/base/media/url/dQB0bBbJz1p4QLBbpvAjJ7lQeGaU9eaJ\\\" style=\\\"width: 597px; height: 326.773px;\\\" data-status=\\\"201\\\" data-data=\\\"[object Object]\\\" data-resource=\\\"media\\\" data-total_count=\\\"1\\\">As soon as you start typing, the search will return previews of the top results, which you can browse quickly. You can also click the <strong>Open more results</strong> link to see a full list of the search results.</p><p>Learn more in <a href=\\\"https://support.kayako.com/article/1164-unified-search\\\">our article about unified search and what you can do with it</a>.</p></li><li><p><strong>'Add new' menu</strong> — Right above the search bar is a little <strong>+</strong> button. Clicking this will open up a submenu where you can create new cases, users, and organizations.<br><img class=\\\"fr-dib fr-draggable\\\" src=\\\"https://support.kayako.com/base/media/url/dEVg2PwO6NwwBBAIdtU7zfABcumUgWTQ\\\" style=\\\"width: 368px; height: 261.28px;\\\" data-status=\\\"201\\\" data-data=\\\"[object Object]\\\" data-resource=\\\"media\\\" data-total_count=\\\"1\\\">You can click the icon for the type of content you want to create. Kayako will then prompt you for a basic detail or two. Once you hit the <strong>Add</strong> or <strong>Next</strong> button, you'll be taken to the page for your new content and have the chance to fill in all the details.</p><p>Learn more in our articles about <a href=\\\"https://support.kayako.com/article/1168-responding-to-cases\\\">responding to cases</a>, <a href=\\\"https://support.kayako.com/article/1180-creating-user-accounts\\\">creating user accounts</a>, and <a href=\\\"https://support.kayako.com/article/1184-managing-customer-organizations\\\">adding customer organizations</a>.</p></li></ul>\",\n" +
                "                    \"created_at\": \"2016-06-30T16:13:11+00:00\",\n" +
                "                    \"updated_at\": \"2016-06-30T16:13:11+00:00\",\n" +
                "                    \"resource_type\": \"locale_field\",\n" +
                "                    \"resource_url\": \"https://support.kayako.com/api/v1/locale/fields/1588\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"keywords\": null,\n" +
                "            \"section\": {\n" +
                ...
                "            \"total_comments\": 0,\n" +
                "            \"created_at\": \"2016-06-30T16:13:11+00:00\",\n" +
                "            \"published_at\": \"2016-06-30T23:20:32+00:00\",\n" +
                "            \"updated_at\": \"2016-06-30T23:20:32+00:00\",\n" +
                "            \"resource_type\": \"article\",\n" +
                "            \"resource_url\": \"https://support.kayako.com/api/v1/articles/1178\"\n" +
                "        },\n" +
                "        {\n" +
                "            \"id\": 1177,\n" +
                "            \"uuid\": \"aab8ac87-b2b1-5ce2-8350-8d6fd9eac41d\",\n" +
                "            \"titles\": [\n" +
                "                {\n" +
                "                    \"id\": 1585,\n" +
                "                    \"locale\": \"en-us\",\n" +
                "                    \"translation\": \"Getting acquainted with the admin area\",\n" +
                "                    \"created_at\": \"2016-06-30T16:12:40+00:00\",\n" +
                "                    \"updated_at\": \"2016-06-30T16:12:40+00:00\",\n" +
                "                    \"resource_type\": \"locale_field\",\n" +
                "                    \"resource_url\": \"https://support.kayako.com/api/v1/locale/fields/1585\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"slugs\": [\n" +
                "                {\n" +
                "                    \"locale\": \"en-us\",\n" +
                "                    \"translation\": \"1177-getting-acquainted-with-the-admin-area\",\n" +
                "                    \"resource_type\": \"slug\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"contents\": [\n" +
                ...
                "                    \"id\": 1586,\n" +
                "                    \"locale\": \"en-us\",\n" +
                "                    \"translation\": \"<p>If you&#39;re a support manager or other power user, you&#39;ll\\nneed to get to know the admin area of Kayako. The admin area is\\nhome to a lot of workhorse Kayako features, including the\\nautomation engine, branding, and localization tools, and\\nconfiguration options for case views, fields, and forms.</p>\\n<p>In this article, we&#39;ll give you a high-level introduction to\\nthe admin area of Kayako. We&#39;ll also highlight some of the\\nfeatures you may want to try out next, with links off to other\\nareas of the user guide.</p>\\n<h2>Exploring Kayako&#39;s admin features</h2>\\n<p>When you sign in to Kayako with an administrator account,\\nyou&#39;ll see a gear icon on the top toolbar throughout the agent\\narea.</p>\\n<p>\\n<img src=\\\"https://support.kayako.com/base/media/url/934kYUeEyW0fYvFyT8uwz8NYVMJjk6HQ\\\"/>\\n</p>\\n<p>Clicking on the gear icon will take you into the admin area. You\\ncan also log directly into the admin area by adding\\n&#39;/admin&#39; to the end of your Help Center URL.</p>\\n<p>What you see in the admin area will depend on what permissions\\nyour administrator account has. In this article, we&#39;ll cover\\nall the possible configuration options you&#39;d see if you have\\nfull administrative access.</p>\\n<p>\\n<em>NOTE: To learn more, check our \\n<a href=\\\"https://support.kayako.com/article/1183-assigning-user-roles-to-control-access\\\" rel=\\\"nofollow\\\">\\nuser guide article about user roles and permissions</a>.</em>\\n</p>\\n<p>No matter where you are in the admin area, you&#39;ll see a\\nsidebar menu on the left. Let&#39;s take a quick look at each\\nsection of that menu:</p>\\n<ul>\\n<li>\\n<strong>Channels</strong> — Here you&#39;ll be able to add and edit\\nthe channels you use to communicate with your customers. You can\\nmanage your support team&#39;s \\n<a href=\\\"https://support.kayako.com/article/1147-configuring-email-support\\\" rel=\\\"nofollow\\\">\\nemail addresses</a>, \\n<a href=\\\"https://support.kayako.com/article/1171-enabling-kayako-messenger\\\" rel=\\\"nofollow\\\">\\nMessenger instances</a>, \\n<a href=\\\"https://support.kayako.com/article/1148-setting-up-twitter-support\\\" rel=\\\"nofollow\\\">\\nTwitter accounts</a>, \\n<a href=\\\"https://support.kayako.com/article/1149-adding-facebook-support\\\" rel=\\\"nofollow\\\">\\nFacebook pages</a>, and \\n<a href=\\\"https://support.kayako.com/article/1170-webhooks\\\" rel=\\\"nofollow\\\">incoming\\nwebhooks</a> from here.</li>\\n<li>\\n<strong>Apps</strong>— In this section, you&#39;ll find settings\\nfor hooking up Kayako integrations, including communicating with\\nother apps using \\n<a href=\\\"https://support.kayako.com/article/1169-zapier\\\" rel=\\\"nofollow\\\">Zapier</a>\\nor manually creating user-defined \\n<a href=\\\"https://support.kayako.com/article/1146-defining-custom-endpoints\\\" rel=\\\"nofollow\\\">\\nendpoints</a> to enable further integrations.</li>\\n<li>\\n<strong>Manage</strong> — You can use the options in this section\\nto customize how your team breaks down their caseload with \\n<a href=\\\"https://support.kayako.com/article/1150-adding-and-editing-views\\\" rel=\\\"nofollow\\\">\\ncase views</a>, what kind of information you track for your cases\\nwith case \\n<a href=\\\"https://support.kayako.com/article/1151-adding-custom-fields-for-cases-users-and-organizations\\\" rel=\\\"nofollow\\\">\\nfields</a> and \\n<a href=\\\"https://support.kayako.com/article/1152-customizing-case-forms\\\" rel=\\\"nofollow\\\">\\nforms</a>. In addition, you&#39;ll be able to build up a collection\\nof reusable case replies and updates using \\n<a href=\\\"https://support.kayako.com/article/1153-automating-common-replies-and-updates-using-macros\\\" rel=\\\"nofollow\\\">\\nmacros</a>. And if you&#39;re providing \\n<a href=\\\"https://support.kayako.com/article/1154-localization\\\" rel=\\\"nofollow\\\">multi-lingual</a>\\nor \\n<a href=\\\"https://support.kayako.com/article/1155-brands\\\" rel=\\\"nofollow\\\">multi-brand</a>\\nsupport from your Kayako, you&#39;ll find settings for those\\nfeatures here.</li>\\n<li>\\n<strong>People</strong> — The options in this section let you \\n<a href=\\\"https://support.kayako.com/article/1180-creating-user-accounts\\\" rel=\\\"nofollow\\\">\\nadd and configure user accounts</a> for both your support team and\\nyour customers. You can also configure user roles and permissions,\\nand group your users into \\n<a href=\\\"https://support.kayako.com/article/1156-grouping-staff-users-into-teams\\\" rel=\\\"nofollow\\\">\\nstaff teams</a> or \\n<a href=\\\"https://support.kayako.com/article/1184-managing-customer-organizations\\\" rel=\\\"nofollow\\\">\\ncustomer organizations</a>.</li>\\n<li>\\n<strong>Automation</strong> — Under this heading you&#39;ll find\\noptions for building powerful automations, including \\n<a href=\\\"https://support.kayako.com/article/1158-establishing-slas-and-escalations\\\" rel=\\\"nofollow\\\">\\nSLAs</a> and \\n<a href=\\\"https://support.kayako.com/article/1159-creating-automations-with-triggers-and-monitors\\\" rel=\\\"nofollow\\\">\\ncase triggers and monitors</a>. If you haven&#39;t gotten started\\nwith automation yet, we&#39;d recommend you start with our \\n<a href=\\\"https://support.kayako.com/article/1167-automation-intro\\\" rel=\\\"nofollow\\\">intro\\nto automation article</a>.</li>\\n<li>\\n<strong>Account Settings</strong> — This section of the menu is\\nhome to all your Kayako account settings. You&#39;ll be able to\\nview and edit your account details, change your plan, and edit your\\nsecurity settings.</li>\\n</ul>\",\n" +
                "                    \"created_at\": \"2016-06-30T16:12:40+00:00\",\n" +
                "                    \"updated_at\": \"2016-06-30T16:12:40+00:00\",\n" +
                "                    \"resource_type\": \"locale_field\",\n" +
                "                    \"resource_url\": \"https://support.kayako.com/api/v1/locale/fields/1586\"\n" +
                "                }\n" +
                "            ],\n" +
                "            \"keywords\": null,\n" +
                "            \"section\": {\n" +
                ...
                "            \"total_comments\": 2,\n" +
                "            \"created_at\": \"2016-06-30T16:12:40+00:00\",\n" +
                "            \"published_at\": \"2016-06-30T23:21:54+00:00\",\n" +
                "            \"updated_at\": \"2016-07-04T09:13:46+00:00\",\n" +
                "            \"resource_type\": \"article\",\n" +
                "            \"resource_url\": \"https://support.kayako.com/api/v1/articles/1177\"\n" +
                "        }\n" +
                "    ],\n" +
                "    \"resource\": \"article\",\n" +
                "    \"offset\": 0,\n" +
